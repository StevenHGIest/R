crx <- read.csv("../Downloads/crx.csv", header=FALSE)
...
for (ncol in colNumericas)
{
  ...
  # Para convertir de factor a numeri primero lo convertimos en caracter  despues a numerico
...
write.table(crxNormal, file = "", sep = "\t", eol= "\n", dec = ".")
...
# Vaciar los datos a un archivo
write.table(crxEstandar, file = "/Users/mirna/Documents/IEST/1.MachineLearningMP/Tema1 Introduccio??n/R/estandar?.txt", sep = "\t", eol= "\n", dec = ".")
